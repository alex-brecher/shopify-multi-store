...
import { catalogHealth, compareCatalog, compareCollections, compareInventory, comparePrices, customerGrowth, duplicateSkuReport, listUnfulfilledOrders, lowStockReport, orderSummary, portfolioSnapshot, recentProductChanges, storeLocations } from "./reports.js";
...
server.registerTool("shopify_order_summary", {
...
server.registerTool("shopify_low_stock_report", {
...
server.registerTool("shopify_catalog_health", {
...
server.registerTool("shopify_recent_product_changes", {
...
server.registerTool("shopify_customer_growth", {
...
server.registerTool("shopify_compare_collections", {
...
server.registerTool("shopify_store_locations", {
...
server.registerTool("shopify_duplicate_sku_report", {
...
server.registerTool("shopify_compare_prices", {
