...
The candidate exposes 54 tools through MCP.
...
- Forty-five automated tests pass on Node 20 and Node 25.9.0. They cover the original workflows, preview receipts, generated concepts, theme configuration, and source selection.
